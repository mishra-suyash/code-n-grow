...
const Login: React.FC<LoginProps> = () => {
  ...
  <div className="bg-gray-700 text-white text-sm p-3 rounded-lg">
    <p className="font-medium">Sample Login Credentials</p>
    <p>Email: <span className="text-blue-400">contact@suyashmishra.com</span></p>
    <p>Password: <span className="text-blue-400">crackme</span></p>
  </div>
